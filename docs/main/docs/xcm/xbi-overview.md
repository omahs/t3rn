...
Since XBI's goal is to agree on a standart to be adopted from as many parachains as possible, we are more then welcome to see contrinutions on our public [repo](https://github.com/t3rn/xbi).